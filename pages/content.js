...
function Validate({content}){
    ...
    async function Register() {
        ...
        if (hasMatch) {
            ...
            let item = {userid, title, imageurl,Content,CategoryID,Keywords,Likes,Comments}
            item.userid=17;
            item.Likes=0;
            item.Comments=0;
                ...
                <div class="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-gray rounded-xl mx-auto shadow-lg overflow-hidden">
                   <div class="w-full lg:w-1/2 flex flex-col items-center justify-center bg-gradient-to-l bg-orange-400 py-16 px-12" >
                       ...
                       <label htmlFor="Title" class="text-gray">Başlık</label>
                            ...
                            <input value={Keywords} onChange={(e) => setKeywords(e.target.value)}type="text" placeholder="örn.:bilim,teknik vs" class="border border-gray-400 py-1 px-2 w-full"/>
        ...
        <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                   value={CategoryID} onClick={(e) => setCategoryID(1)}
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                   value={CategoryID} onClick={(e) => setCategoryID(2)}
