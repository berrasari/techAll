                    ...
                    <div class="relative px-4 py-10 bg-stone-300 bg-opacity-70 shadow-lg sm:rounded-3xl sm:p-20">
                        <div class="max-w-md mx-auto">
                            <div>
                                ...
                                <h2 class='font-semibold'>OKUYUCU HESABI</h2>
                            </div>
                            <div class="divide-y divide-gray-200" >
                                <div class="py-8 my-3 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <a href="/registerauthor">
                                        <div  class="mt-6 text-gray-600 text-center text-sm border-b-2  border-orange-500 hover:text-orange-500">Yazar olarak kayıt olmak için tıklayınız.</div>
                                    </a>
                                    
                                    <a href="/login">
                                        <div class="mt-6 text-gray-600 text-center text-sm border-b-2 border-orange-500 hover:text-orange-500">Hesabınız var ise giriş yapabilirsiniz.</div>
                                    </a>
